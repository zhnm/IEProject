...
<html>
    ...
    <body>
        ...
        <div class="grade">
            ...
            <div class="container">
                <div class="row">
				<form charset=utf-8 method="post" action="<c:url value = "/login/professorlist/courselist" context="/MVCSesssion3"/>">
                    <table>
                        <c:forEach items="${list}" var="l">
                            <tr>
                                <td>${l.key}</td>
                                <td>${l.value}</td>
				<td><button name="id" type="submit" value="${l.key}" />انتخاب</button></td>
                            </tr>
                        </c:forEach>
                    </table>  
</form>					
